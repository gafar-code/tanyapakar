...
class DaftarKonsumenScreen extends StatefulWidget {
  const DaftarKonsumenScreen({Key? key}) : super(key: key);

  @override
  _WidgetState createState() => _WidgetState();
}

class _WidgetState extends State<DaftarKonsumenScreen> {
